        ...
        <div className="row disp-flex">
          <div className="col-md-7">
            <div className="description">
              ...
              helped you rediscover the beauty in life. Did it surprise you?
              <br />
              <br />
              As an independent bookstore, we strive to offer the same variety
              and richness of experience as the books on our shelves. And
              because the only people we’re beholden to are our customers and
              ourselves, we can focus on what really matters — promoting diverse
              ...
              readers and authors we’re lucky to be a part of.
              <br />
              <br />
              Thank you for supporting these lofty goals. Your choice sustains a
              family business with over 500 local booksellers, and allows us to
              follow our passion for getting the right books into the right
              hands, 365 days a year.
            </div>
            <div className="row center-div">
              <p>
                {" "}
                <Link to="/shop" className="btn btn-primary shopping-button">
                  Start Shopping
                </Link>
              </p>
            </div>
